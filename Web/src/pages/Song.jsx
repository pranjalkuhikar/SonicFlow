...
const Song = () => {
  ...
  return (
    <SidebarLayout
      ...
      title={song ? song.title : "Loading track"}
      subtitle={song ? song.artist : "Fetching metadata…"}
    >
      {isFetching ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="flex w-40 items-center gap-2 rounded-full border border-white/30 px-6 py-2 text-sm font-semibold hover:border-white/70"
              >
                ...
                <span>
                  {isPlaying && playingSong?._id === song._id ? "Pause" : "Play"} track
                </span>
              </button>
              <Link
                to="/"
